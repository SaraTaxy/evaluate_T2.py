...
# Train
python3 ./src/model/train_model_T2.py -f ./configs/resnet18/T2/resnet18_14_t2.yaml

# Predict
python3 ./src/model/prediction_model_T2.py -f ./configs/resnet18/T2/resnet18_14_t2.yaml

# Evaluate
python3 ./src/model/evaluate_T2.py -f ./configs/resnet18/T2/resnet18_14_t2.yaml
