...
# Train
python3 ./src/model/train_model_FUSION.py -f ./configs/resnet18/Fusion_pretrained_weight/resnet18_WEIGHT_MMTM_1_4_freeze.yaml

# Predict
python3 ./src/model/prediction_model_FUSION.py -f ./configs/resnet18/Fusion_pretrained_weight/resnet18_WEIGHT_MMTM_1_4_freeze.yaml

# Evaluate
python3 ./src/model/evaluate_FUSION.py -f ./configs/resnet18/Fusion_pretrained_weight/resnet18_WEIGHT_MMTM_1_4_freeze.yaml
