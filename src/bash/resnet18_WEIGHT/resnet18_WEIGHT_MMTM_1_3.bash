...
# Train
python3 ./src/model/train_model_T2.py -f ./configs/resnet18/Fusion_pretrained_weight/resnet18_WEIGHT_MMTM_1_3.yaml

# Predict
python3 ./src/model/prediction_model_T2.py -f ./configs/resnet18/Fusion_pretrained_weight/resnet18_WEIGHT_MMTM_1_3.yaml

# Evaluate
python3 ./src/model/evaluate_T2.py -f ./configs/resnet18/Fusion_pretrained_weight/resnet18_WEIGHT_MMTM_1_3.yaml
