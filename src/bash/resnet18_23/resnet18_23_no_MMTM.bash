...
# Train
python3 ./src/model/train_model_T2.py -f ./configs/resnet18/Fusion_23_Weight/resnet18_FUSION_23_no_MMTM.yaml

# Predict
python3 ./src/model/prediction_model_T2.py -f ./configs/resnet18/Fusion_23_Weight/resnet18_FUSION_23_no_MMTM.yaml

# Evaluate
python3 ./src/model/evaluate_T2.py -f ./configs/resnet18/Fusion_23_Weight/resnet18_FUSION_23_no_MMTM.yaml
