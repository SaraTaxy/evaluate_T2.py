...
# Train
python3 ./src/model/train_model_FUSION.py -f ./configs/resnet18/Fusion_23_Weight/resnet18_23_MMTM_3.yaml

# Predict
python3 ./src/model/prediction_model_FUSION.py -f ./configs/resnet18/Fusion_23_Weight/resnet18_23_MMTM_3.yaml

# Evaluate
python3 ./src/model/evaluate_FUSION.py -f ./configs/resnet18/Fusion_23_Weight/resnet18_23_MMTM_3.yaml
