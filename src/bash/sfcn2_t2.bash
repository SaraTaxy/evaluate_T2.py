...
# Train
python3 ./src/model/train_model_T2.py -f ./configs/sfcn2/T2/sfcn2_t2_14.yaml

# Predict
python3 ./src/model/prediction_model_T2.py -f ./configs/sfcn2/T2/sfcn2_t2_14.yaml

# Evaluate
python3 ./src/model/evaluate_T2.py -f ./configs/sfcn2/T2/sfcn2_t2_14.yaml
