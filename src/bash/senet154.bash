...
# Train
python3 ./src/model/train_model_T2.py -f ./configs/senet154/T2/senet154_14_t2.yaml

# Predict
python3 ./src/model/prediction_model_T2.py -f ./configs/senet154/T2/senet154_14_t2.yaml

# Evaluate
python3 ./src/model/evaluate_T2.py -f ./configs/senet154/T2/senet154_14_t2.yaml
